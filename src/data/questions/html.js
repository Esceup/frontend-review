  ...
  topics: [
    {
      ...
      questions: [
        ...
        },
        {
          id: "html-20",
          hot: true,
          q: "С помощью какого тега указать браузеру, как подстраивать размеры и маштаб веб-страницы под экран устройства?",
          a:
            ...
            "У тега meta с name=viewport внутри content:\n" +
            "- width=dedice-width = ширина страницы равна ширине экрана устройства\n" +
